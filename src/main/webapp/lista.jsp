    			...
    			<tbody>
    				<c:forEach items="${clientes}" var="cliente">
						<tr>
							...
							<td>
								<a class="btn btn-primary" type="submit" href="ClienteDelete?clienteId=${cliente.id}">Deletar</a>
								<a class="btn btn-primary" type="submit" href="ClienteUpdate?clienteId=${cliente.id}">Atualizar</a>
							</td>
						</tr>
					</c:forEach>
    			</tbody>
